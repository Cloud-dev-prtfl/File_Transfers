...
function(query, https, serverWidget, runtime, log, record, search) {
    ...
    function renderUI(context) {
        const form = serverWidget.createForm({ title: 'NetSuite AI assistant MAS: Search Auto-Creator' });
        ...
        htmlField.defaultValue = `
            ...
            <div id="chat-box">
                <div class="ai-msg">I am NetSuite AI assistant. My multi-agent pipeline is active. How can I help you today?</div>
            </div>
