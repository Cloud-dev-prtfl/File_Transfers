    ...
    const onRequest = (context) => {
        if (context.request.method === 'GET') {
            ...
            try {
                ...
                // --- UI UPDATE: Display the original user request ---
                const originalQueryField = resultForm.addField({
                    id: 'custpage_original_query',
                    type: serverWidget.FieldType.LONGTEXT,
                    label: 'Your Request'
                });
                originalQueryField.defaultValue = userQuery;
                originalQueryField.updateDisplayType({ displayType: serverWidget.FieldDisplayType.INLINE });
                // ---------------------------------------------------
